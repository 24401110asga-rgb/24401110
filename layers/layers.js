...
var lyr_02_WEB_READY_OUTPUTRiversandCreeks_1 = new ol.layer.Vector({
    ...
    <img src="styles/legend/02_WEB_READY_OUTPUTRiversandCreeks_1_0.png" /> Major river<br />\
    <img src="styles/legend/02_WEB_READY_OUTPUTRiversandCreeks_1_1.png" /> Creek/stream<br />' });
...
var group_group1 = new ol.layer.Group({
                                layers: [lyr_02_WEB_READY_OUTPUTRiversandCreeks_1,lyr_02_WEB_READY_OUTPUTInundationRiskZones_2,lyr_02_WEB_READY_OUTPUTRoadCentreline_3,lyr_02_WEB_READY_OUTPUTRoadGradientandSlope_4,lyr_02_WEB_READY_OUTPUTStreamOutlets_5,lyr_02_WEB_READY_OUTPUTCulverts_6,lyr_02_WEB_READY_OUTPUTChainagePoints_7,],
                                fold: 'open',
                                title: 'group1'});
...
var layersList = [lyr_OpenTopoMap_0,group_group1];
...
lyr_02_WEB_READY_OUTPUTRoadCentreline_3.set('fieldAliases', {'fid': 'fid', 'road_id': 'road_id', 'feature_type': 'feature_type', 'length_m': 'length_m', });
...
lyr_02_WEB_READY_OUTPUTRiversandCreeks_1.set('fieldImages', {'fid': 'TextEdit', 'waterway_id': 'TextEdit', 'waterway_type': 'TextEdit', });
lyr_02_WEB_READY_OUTPUTInundationRiskZones_2.set('fieldImages', {'fid': 'TextEdit', 'risk_zone_id': 'TextEdit', 'risk_level': 'TextEdit', 'risk_rank': 'TextEdit', 'source_description': 'TextEdit', });
lyr_02_WEB_READY_OUTPUTRoadCentreline_3.set('fieldImages', {'fid': 'TextEdit', 'road_id': 'TextEdit', 'feature_type': 'TextEdit', 'length_m': 'TextEdit', });
lyr_02_WEB_READY_OUTPUTRoadGradientandSlope_4.set('fieldImages', {'fid': 'TextEdit', 'segment_id': 'TextEdit', 'gradient_pct': 'TextEdit', 'terrain_class': 'TextEdit', 'chainage': 'TextEdit', 'segment_length_m': 'TextEdit', 'source_gradient': 'TextEdit', 'source_category': 'TextEdit', });
...
lyr_02_WEB_READY_OUTPUTCulverts_6.set('fieldImages', {'fid': 'TextEdit', 'culvert_id': 'TextEdit', 'structure': 'TextEdit', 'length_m': 'TextEdit', 'diameter_m': 'TextEdit', 'condition': 'TextEdit', 'function': 'TextEdit', 'recommendation': 'TextEdit', 'source_condition': 'TextEdit', 'data_note': 'TextEdit', });
lyr_02_WEB_READY_OUTPUTChainagePoints_7.set('fieldImages', {'fid': 'TextEdit', 'chainage_id': 'TextEdit', 'chainage': 'TextEdit', 'elevation_m': 'TextEdit', 'easting': 'TextEdit', 'northing': 'TextEdit', });
lyr_02_WEB_READY_OUTPUTRiversandCreeks_1.set('fieldLabels', {'fid': 'hidden field', 'waterway_id': 'inline label - always visible', 'waterway_type': 'inline label - always visible', });
lyr_02_WEB_READY_OUTPUTInundationRiskZones_2.set('fieldLabels', {'fid': 'hidden field', 'risk_zone_id': 'inline label - always visible', 'risk_level': 'inline label - always visible', 'risk_rank': 'inline label - always visible', 'source_description': 'no label', });
lyr_02_WEB_READY_OUTPUTRoadCentreline_3.set('fieldLabels', {'fid': 'hidden field', 'road_id': 'inline label - always visible', 'feature_type': 'inline label - always visible', 'length_m': 'inline label - always visible', });
lyr_02_WEB_READY_OUTPUTRoadGradientandSlope_4.set('fieldLabels', {'fid': 'hidden field', 'segment_id': 'inline label - always visible', 'gradient_pct': 'inline label - always visible', 'terrain_class': 'inline label - always visible', 'chainage': 'inline label - always visible', 'segment_length_m': 'inline label - always visible', 'source_gradient': 'no label', 'source_category': 'no label', });
...
lyr_02_WEB_READY_OUTPUTCulverts_6.set('fieldLabels', {'fid': 'hidden field', 'culvert_id': 'inline label - always visible', 'structure': 'inline label - always visible', 'length_m': 'inline label - always visible', 'diameter_m': 'inline label - always visible', 'condition': 'inline label - always visible', 'function': 'inline label - always visible', 'recommendation': 'inline label - visible with data', 'source_condition': 'hidden field', 'data_note': 'inline label - visible with data', });
lyr_02_WEB_READY_OUTPUTChainagePoints_7.set('fieldLabels', {'fid': 'hidden field', 'chainage_id': 'inline label - always visible', 'chainage': 'inline label - always visible', 'elevation_m': 'inline label - always visible', 'easting': 'hidden field', 'northing': 'hidden field', });
